use crate::simulation::state::Stateful;
...
pub const STRUT_STIFFNESS_DEFAULT: f32 = 10.0;
pub const STRUT_DAMPING_DEFAULT: f32 = 3.0;
...
impl SpringyMesh {
    ...
    // TODO I think our collision handling can be in this function
